	...
	<td>
		<div style="margin-left:280px margin-top:-60px" class="right">
			...
			<div class="Dashboard">
				...
				<span class="heading"><br><center>Edit Food</center></span>
				<br><br><br><br>
				<form name="EditFood" method="post" action="editFoodSql.php">
				<table style="max-width:100% max-height:100%;">
					<tr>
						...
						<td>
							<input type="text"  value="<?php echo $_GET['id'];?>" disabled style="margin-left:60%;"/>
							<input type="hidden" name="id" value="<?php echo $_GET['id'];?>"  style="margin-left:60%;"/>
						</td>
						<td></td>
						<td>
					...
					<tr>
					<td>
					<input type="submit" value="Edit" class="add" onclick="edit()"/>
					</td>
					<td>
